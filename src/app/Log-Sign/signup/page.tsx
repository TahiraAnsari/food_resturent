        ...
        <>
            ...
            <div className="relative h-[200px] bg-cover bg-center" style={{ backgroundImage: "url('/FigmaImages/img110.png')" }}>
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <h1 className="text-white text-4xl font-bold">SignUp Page</h1>
            ...
            <div className="w-screen h-[700px] bg-white justify-items-center content-center">
                <div className="w-[400px] h-[500px]">
                    ...
                    <Button variant={"default"} className="w-[270px] h-[40px] mx-14 my-4 cursor-pointer border border-orange-500">Sign Up</Button>
                    <Link href={"/Log-Sign/login"}>  <p className="text-orange-500 hover:text-green-500 text-center text-[13px] cursor-pointer mb-3">Back to the Login page</p></Link>
