...
export default function ShopList(){
    return(
       ...
       <div className="relative h-[200px] bg-cover bg-center" style={{ backgroundImage: "url('/FigmaImages/img110.png')" }}>
            ...
            <div className="bg-white w-full h-[3300px] sm:h-[1300px] justify-items-center">
                <div className="w-full sm:w-[800px] h-[800px] py-5">
                    ...
                    <div className="flex justify-between mt-5">
                        <div className="w-[220px] h-[3220px] sm:w-[550px] sm:h-[1100px]">
                            <div className="flex flex-col gap-16 sm:gap-2 my-2 sm:flex-row justify-items-center content-center items-center">
                            ...
                            <div className="flex flex-col gap-16 sm:gap-2 mt-16 my-2 sm:flex-row justify-items-center content-center items-center">
                                <div className="w-[200px] h-[150px] sm:w-[200px] sm:h-[200px]">
                                <Image 
                            ...
                            <div className="flex flex-col gap-16 sm:gap-2 mt-16 my-2 sm:flex-row justify-items-center content-center items-center">
                                <div className="w-[200px] h-[150px] sm:w-[200px] sm:h-[200px] content-center  items-center justify-items-center">
                                    <Image 
                        ...
                        <div className="w-[150px] h-[1000px] sm:w-[200px] sm:h-[1100px] bg-blue-300 mt-20">
                            <div className="flex">
                            <div className="bg-gray-500 w-[110px] h-[30px] shadow-md"></div>
                            <div className="bg-orange-500 w-[30px] h-[30px] shadow-md"></div>
                            </div>
                        </div>
                    </div>
                </div>
